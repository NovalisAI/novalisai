    ...
    <div className="py-24">
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="heading-6 mb-12 text-center lg:max-w-150">
          To simplify your creative journey, Zappicon Library offers the perfect
          integration for your digital projects.
        </p>
      </div>
